...
- The latest `pnpm verify` and `pnpm demo:acceptance` reports pass but truthfully record commit `f97637b4152ef697785167b5df5aa09f9ab7deea` with `dirty=true`. They verify the present development worktree; they are not a clean exact-commit release or tag attestation.
