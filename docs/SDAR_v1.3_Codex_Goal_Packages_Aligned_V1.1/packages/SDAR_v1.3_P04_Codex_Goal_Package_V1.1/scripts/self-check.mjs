...
if(manifest.packageId!=='SDAR-V1.3-P04') throw new Error('packageId');
if(manifest.sequence!==4||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G07,G08') throw new Error('goals');
