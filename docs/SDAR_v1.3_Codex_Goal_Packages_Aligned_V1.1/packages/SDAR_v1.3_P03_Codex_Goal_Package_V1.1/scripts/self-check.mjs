...
if(manifest.packageId!=='SDAR-V1.3-P03') throw new Error('packageId');
if(manifest.sequence!==3||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G05,G06') throw new Error('goals');
