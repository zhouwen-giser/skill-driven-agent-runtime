...
for(const name of ['ExperienceActivityRef','ExperienceTraceEvent','ProcessVariant','WorkflowPattern']) if(lock.producedContracts[name]?.version!=='1.2') throw new Error(`v1.2 contract ${name}`);
