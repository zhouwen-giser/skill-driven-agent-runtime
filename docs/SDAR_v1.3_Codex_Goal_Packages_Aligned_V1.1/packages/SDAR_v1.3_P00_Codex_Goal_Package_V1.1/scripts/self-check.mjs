...
if(manifest.packageId!=='SDAR-V1.3-P00') throw new Error('packageId');
if(manifest.sequence!==0||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G00') throw new Error('goals');
