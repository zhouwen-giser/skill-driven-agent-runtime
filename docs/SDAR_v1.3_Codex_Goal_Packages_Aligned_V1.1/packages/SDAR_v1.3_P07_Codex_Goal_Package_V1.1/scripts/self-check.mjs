...
if(manifest.packageId!=='SDAR-V1.3-P07') throw new Error('packageId');
if(manifest.sequence!==7||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G13,G14') throw new Error('goals');
