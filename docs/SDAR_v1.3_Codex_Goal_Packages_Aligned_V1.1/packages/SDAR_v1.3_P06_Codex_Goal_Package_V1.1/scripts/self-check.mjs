...
if(manifest.packageId!=='SDAR-V1.3-P06') throw new Error('packageId');
if(manifest.sequence!==6||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
if(manifest.contractRegistryVersion!=='1.2'||lock.registryVersion!=='1.2'||manifest.contractRegistrySha256!=='8aa828faf544b2cad3d3eb72bfc0935b02ba324a517de1563308862fc7d60dee'||lock.registrySha256!=='8aa828faf544b2cad3d3eb72bfc0935b02ba324a517de1563308862fc7d60dee') throw new Error('registry');
if(manifest.atomicGoals.join(',')!=='G11,G12') throw new Error('goals');
