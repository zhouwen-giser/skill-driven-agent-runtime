# P06 Start Execution Checklist

1. Use future `v1.2.3-final` lineage; do not bind the historical reference SHA in this package.
2. Validate Registry V1.2 SHA `8aa828faf544b2cad3d3eb72bfc0935b02ba324a517de1563308862fc7d60dee`.
3. Validate package self-check: `node scripts/self-check.mjs`.
4. Required merged predecessors: `P00, P01, P02, P03, P04, P05`.
