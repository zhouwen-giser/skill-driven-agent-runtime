...
if(manifest.packageId!=='SDAR-V1.3-P11') throw new Error('packageId');
if(manifest.sequence!==11||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G19,G20') throw new Error('goals');
