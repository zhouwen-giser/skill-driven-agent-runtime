...
if(manifest.packageId!=='SDAR-V1.3-P02') throw new Error('packageId');
if(manifest.sequence!==2||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G02,G03,G04') throw new Error('goals');
