...
if(manifest.packageId!=='SDAR-V1.3-P10') throw new Error('packageId');
if(manifest.sequence!==10||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G17,G18') throw new Error('goals');
