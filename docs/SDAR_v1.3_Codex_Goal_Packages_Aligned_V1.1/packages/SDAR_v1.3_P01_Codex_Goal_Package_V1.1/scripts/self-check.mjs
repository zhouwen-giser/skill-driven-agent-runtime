...
if(manifest.packageId!=='SDAR-V1.3-P01') throw new Error('packageId');
if(manifest.sequence!==1||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G01') throw new Error('goals');
