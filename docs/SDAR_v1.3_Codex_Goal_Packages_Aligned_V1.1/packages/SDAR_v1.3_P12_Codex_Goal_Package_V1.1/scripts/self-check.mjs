...
if(manifest.packageId!=='SDAR-V1.3-P12') throw new Error('packageId');
if(manifest.sequence!==12||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G21') throw new Error('goals');
