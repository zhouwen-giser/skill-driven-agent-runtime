...
if(manifest.packageId!=='SDAR-V1.3-P09') throw new Error('packageId');
if(manifest.sequence!==9||manifest.totalFormalPackages!==14||manifest.formalPackage!==true) throw new Error('sequence');
...
if(manifest.atomicGoals.join(',')!=='G16') throw new Error('goals');
