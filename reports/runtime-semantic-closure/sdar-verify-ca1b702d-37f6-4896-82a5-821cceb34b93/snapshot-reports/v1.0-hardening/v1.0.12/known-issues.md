...
- Model refinement is intentionally data, not authority to execute code. The strict schema,
  provenance invariant and deterministic named dynamic-state policy fail closed. Classification of
  other domain-specific durable facts still depends on the configured model and requires
