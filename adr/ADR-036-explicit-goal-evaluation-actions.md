...
- `request_input` and `capability_gap` persist their full evidence and stop the controller in an explicit waiting state. They do not start another Workflow node.
