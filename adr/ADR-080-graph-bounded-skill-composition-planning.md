...
- `SkillCompositionPlanner` follows only outbound reachable graph edges, rejects cycles across relation kinds, requires current enabled versions and caps traversal at eight levels and 32 related Skills.
