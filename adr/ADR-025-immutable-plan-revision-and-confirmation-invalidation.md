...
- Administrator DAG edits use the canonical WorkflowDefinition serialization produced by the visual editor. The server does not accept executable callbacks, source code, or a second graph runtime.
...
- A visual React DAG editor remains EP-06 scope; this ADR establishes its validated server contract.
