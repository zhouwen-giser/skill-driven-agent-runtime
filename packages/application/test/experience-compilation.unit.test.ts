    ...
    trace: {
      ...
      events: [
        ...
        },
        {
          ...
          actorType: 'runtime',
          activity: {
            activityKey: 'skill-goal:verify-outcome',
            activityKind: 'verification',
            objectiveSummary: 'Verify the formal goal outcome',
            sourcePlanNodeRef: 'skill-goal:verify-outcome',
            sourceSkillGoalRef: 'skill-goal:verify-outcome',
            sourceAttemptRef: 'attempt-verify-outcome',
            capabilityRefs: ['capability-verify'],
            effectRefs: ['effect-goal-verified'],
          },
          capabilityRefs: ['capability-verify'],
...
function compilationRepository(
  ...
  return {
    ...
    findProcessMiningSource: () => Promise.resolve(undefined),
