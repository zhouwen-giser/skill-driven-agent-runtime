...
export const EVIDENCE_RECORD_CATALOG = Object.freeze([
  ...
  defineRecord(
    ...
    control('sdar_control.node_health_observation'),
    [
      'observationId',
      'observationRevision',
      'nodeId',
  ...
  defineRecord(
    ...
    control('sdar_control.control_audit_event[action prefix=plan-template.]'),
    [
      'auditId',
      'actorId',
      'action',
  ...
  defineRecord(
    ...
    runtime('evidence_export_batch + evidence_export_ack[generation0-derived]'),
    [
      'exportId',
      'sourcePartition',
      'batchId',
