...
- [ ] 2026-07-15 18:55 v1.0.4 feature gate passed (217 unit, 58 contract, 42 integration, 42 E2E, 172-file architecture, build and migration paths); publish the feature commit/tag, then audit bug-fixed boundaries.
