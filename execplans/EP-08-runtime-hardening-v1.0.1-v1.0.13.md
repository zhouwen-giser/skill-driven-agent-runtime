...
- [ ] 2026-07-16 v1.0.9 bug-fixed audit revalidates inherited/persisted reachability and uniqueness, bounds 128 relations/64 JSON levels and uses indexed bounded graph reads. Required full `pnpm verify` passes in 87,491 ms with 273 unit, 59 contract, 58 integration, 46 E2E and all static/build/migration/smoke gates; publication remains.
