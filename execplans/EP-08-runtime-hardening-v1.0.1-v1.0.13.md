...
- [ ] 2026-07-16 v1.0.10 feature makes capability gap a terminal Task/WorkflowControl and A2A failed outcome while retaining the active Goal for a new same-Context Task. Feature gate passed 274 unit, 60 contract, 58 integration, 46 E2E, architecture/OpenAPI/build/migrations; publication remains.
