...
- [ ] 2026-07-16 v1.0.12 bug-fixed audit prevents model authority elevation, deterministically rejects forged durable device state and freezes bounded Memory/Embedding snapshots. The required full gate passed 287 unit, 64 contract, 60 integration, 46 E2E, build, migrations and smoke in 85,277 ms; publication remains.
