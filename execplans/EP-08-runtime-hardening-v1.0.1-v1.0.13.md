...
- [ ] 2026-07-16 v1.0.12 feature implements ADR-083, strict durability/authority refinement, durable-only admission, generic provider/dimension-isolated pgvector storage through 0064 and queryable post-commit warnings. The full gate passed 284 unit, 64 contract, 60 integration, 46 E2E, build, migrations and smoke in 86,193 ms; publication remains.
- [ ] Complete the independent v1.0.12 bug-fixed audit and run its required full gate.
