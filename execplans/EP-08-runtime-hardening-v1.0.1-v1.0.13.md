...
- [ ] 2026-07-16 v1.0.13 feature implements ADR-084 process-local Task notifications, post-commit publication across every Task write, PostgreSQL-authoritative safety reload, snapshot-on-timeout and waiter release. The full feature gate passed 296 unit, 64 contract, 60 integration and 46 E2E in 89,011 ms; publication remains.
- [ ] Complete the v1.0.13 bug-fixed audit; run the required full gate and both demos.
