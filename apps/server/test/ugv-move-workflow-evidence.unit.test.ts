...
function remoteLifecycle(
  ...
  return Object.freeze({
    binding: Object.freeze({
      ...
      bindingAuthority: Object.freeze({
        ...
        episodeId: TASK_ID,
        a2aTaskId: TASK_ID,
        providerSourceId: 'smpp-source-ugv-1',
        externalProviderId: 'isr.vehicle.ugv.ugv1',
        externalProviderInstanceId: 'instance-ugv-1',
        externalServerId: 'external-server-ugv-1',
        registryRevision: '2',
      ...
      providerIdentity: Object.freeze({
        ...
        providerInstanceId: 'instance-ugv-1',
      }),
      serverId: 'ugv-runtime-1',
      ...
      authoritySnapshot: Object.freeze({
        ...
        providerBinding: Object.freeze({
          ...
          scope: { tenantId: 'tenant-1', projectId: 'project-1', environment: 'test' },
