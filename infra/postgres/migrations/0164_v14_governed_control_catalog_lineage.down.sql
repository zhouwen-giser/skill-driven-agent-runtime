...
BEGIN
  IF EXISTS (
    SELECT 1
    FROM governed_control_confirmation AS confirmation
    ...
    RAISE EXCEPTION '0164 rollback refused: governed confirmation catalog lineage is no longer present';
  END IF;
END;
$$;
...
WHERE version = '0164_v14_governed_control_catalog_lineage';
