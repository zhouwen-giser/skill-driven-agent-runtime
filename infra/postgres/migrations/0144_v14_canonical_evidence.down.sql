...
DROP TABLE IF EXISTS episode_evidence_manifest;
DROP TABLE IF EXISTS evidence_quality_issue;
DROP TABLE IF EXISTS evidence_projection_issue;
DROP TABLE IF EXISTS evidence_dead_letter;
DROP TABLE IF EXISTS evidence_source_checkpoint;
DROP TABLE IF EXISTS evidence_outbox;
DROP TABLE IF EXISTS evidence_export_state;
DROP TABLE IF EXISTS evidence_export_configuration;
...
DELETE FROM schema_migration WHERE version='0144_v14_canonical_evidence';
